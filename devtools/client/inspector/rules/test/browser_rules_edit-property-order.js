...
add_task(async function() {
  ...
  // rgb(0, 0, 255) = blue
  is((await getValue("#testid", "background-color")), "rgb(0, 0, 255)",
  ...
  // rgb(0, 128, 0) = green
  is((await getValue("#testid", "background-color")), "rgb(0, 128, 0)",
  ...
  is((await getValue("#testid", "background-color")), "rgba(0, 0, 0, 0)",
