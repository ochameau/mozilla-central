...
add_task(function*() {
  ...
  let {toolbox, inspector, testActor} = yield openInspectorForURL("data:text/html;charset=utf-8,<h1>breadcrumb hover test</h1><span>highlights nodes on hover</span>");
