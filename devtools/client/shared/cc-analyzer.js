...
CCAnalyzer.prototype = {
  ...
  run: function (window, aCallback, aWantAllTraces) {
    this.clear();
  ...
  runCC: function (window, aCounter) {
    dump("GC()\n");
    ...
    Cu.schedulePreciseShrinkingGC(() => {
      if (aCounter > 1) {
        ...
        require("sdk/timers").setTimeout(this.runCC.bind(this, window, aCounter - 1), 0);
      } else {
  ...
  processLog: function () {
    ...
    require("sdk/timers").setTimeout(this.processLog.bind(this), 0);
  },
