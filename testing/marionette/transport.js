...
DebuggerTransport.prototype = {
  ...
  onDataAvailable: function DT_onDataAvailable(aRequest, aContext,
    ...
    try {
      ...
      dump("Unexpected error reading from debugging connection: " + e + " - " + e.stack + "\n");
      this.close();
      return;
    }
  },
  ...
  _processIncoming: function DT__processIncoming() {
    ...
    try {
      ...
      dump("Error parsing incoming packet: " + packet + " (" + e + " - " + e.stack + ")\n");
      return true;
    }
    ...
    try {
      ...
      dump("Error handling incoming packet: " + e + " - " + e.stack + "\n");
      dump("Packet was: " + packet + "\n");
    }
