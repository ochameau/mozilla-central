...
JSONPacket.fromHeader = function (header, transport) {
  ...
  //dump("Header matches JSON packet\n");
...
JSONPacket.prototype._readData = function (stream, scriptableStream) {
  //dump("Reading JSON data: _l: " + this.length + " dL: " +
...
BulkPacket.fromHeader = function (header, transport) {
  ...
  //dump("Header matches bulk packet\n");
...
BulkPacket.prototype.read = function (stream) {
  //dump("Reading bulk packet, handing off input stream\n");
  ...
  deferred.promise.then(() => {
    //dump("onReadDone called, ending bulk mode\n");
    this._done = true;
...
BulkPacket.prototype.write = function (stream) {
  //dump("Writing bulk packet\n");

  if (this._outgoingHeader === undefined) {
    //dump("Serializing bulk packet header\n");
  ...
  if (this._outgoingHeader.length) {
    //dump("Writing bulk packet header\n");
  ...
  //dump("Handing off output stream\n");
  ...
  deferred.promise.then(() => {
    //dump("onWriteDone called, ending bulk mode\n");
    this._done = true;
